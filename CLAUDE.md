...
## כללי עבודה — חובה לקרוא לפני כל שינוי

1. **נוגעים רק במה שנדרש** — לא נוגעים בקבצים או קוד שלא קשורים ישירות לבקשה
2. **אל תבצע commit לפני שעבר build** — לפחות `npm run build` בהצלחה לפני כל push
3. **הערות בקוד** — כל מקטע קוד חייב לכלול הערה קצרה שמסבירה מה הוא עושה, כתובה בגוף ראשון ("אני בודק...", "כאן אני שולח...") כאילו בעל הפרויקט כתב אותן
4. **לא לבצע שינויים "שיפורים"** שלא התבקשו — רק מה שהתבקש בדיוק

<!-- build trigger 2026-05-26T11:11:08.435Z -->
