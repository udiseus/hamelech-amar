  ...
  return (
    <div style={{ textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', gap: 8 }}>
        {shares.map(({ label, displayLabel, href, color, icon }) => (
          <a
            key={label}
            href={href}
            target="_blank"
            ...
            onMouseEnter={e => {
              e.currentTarget.style.boxShadow = '0 2px 16px rgba(30,106,168,0.18)'
              e.currentTarget.style.borderColor = 'rgba(30,106,168,0.45)'
            }}
            onMouseLeave={e => {
